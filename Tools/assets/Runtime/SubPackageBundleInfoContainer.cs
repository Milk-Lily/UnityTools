...
namespace Zeus.Framework.Asset
{
    ...
    public class SubPackageBundleInfoContainer
    {
        ...
        public void Save()
        {
            string infoPath = Path.Combine(UnityEngine.Application.dataPath, SubpackageBundleInfoPath);
        ...
        public static SubPackageBundleInfoContainer LoadSubPackageInfo()
        {
            SubPackageBundleInfoContainer container = null;
            try
            {
                if (VFileSystem.ExistsFile(SubpackageBundleInfoPath))
                {
                    byte[] buffer = VFileSystem.ReadAllBytes(SubpackageBundleInfoPath);

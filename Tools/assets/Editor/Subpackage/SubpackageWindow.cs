...
namespace Zeus.Framework.Asset
{
    ...
    public class SubpackageWindow : EditorWindow
    {
        ...
        internal static SubpackageSetting Setting;
        internal static TagAsset TagAsset;
    ...
    public class TagDetailWindow : EditorWindow
    {
        ...
        {
            var tagListWithOthers = SubpackageWindow.TagAsset.TagListForRecord;
            var tempList = AssetListHelper.LoadAssetListFromFiles(new string[1] { tagListWithOthers[_currentTagIndex] }, false);
